...
let REACT_APP_CHAT_ACCESS_TOKEN = localStorage.getItem("REACT_APP_CHAT_ACCESS_TOKEN");
...
function modifyVars() {
  ...
  REACT_APP_CHAT_ACCESS_TOKEN = localStorage.getItem("REACT_APP_CHAT_ACCESS_TOKEN");
...
export {REACT_APP_BILLING_STATUS, REACT_APP_TRIAL_END_DATE, REACT_APP_START_PAYING_DATE, REACT_APP_ZOOM_RATE, REACT_APP_ZOOM_LINK, REACT_APP_COACH, REACT_APP_COACH_FIRST_NAME, REACT_APP_USER_FIRST_NAME, REACT_APP_UI_MODE, REACT_APP_CHAT_USER_ID, REACT_APP_CHAT_ACCESS_TOKEN, testableCoachList, getCoach}