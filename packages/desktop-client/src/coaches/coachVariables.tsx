...
let REACT_APP_USER_EMAIL = localStorage.getItem('REACT_APP_USER_EMAIL');
let REACT_APP_TRIAL_END_DATE = localStorage.getItem('REACT_APP_TRIAL_END_DATE');
let REACT_APP_START_PAYING_DATE = localStorage.getItem(
...
let REACT_APP_COACH_FIRST_NAME = localStorage.getItem(
  'REACT_APP_COACH_FIRST_NAME',
);
let REACT_APP_USER_FIRST_NAME = localStorage.getItem(
...
function modifyVars() {
  ...
  REACT_APP_START_PAYING_DATE = localStorage.getItem(
    'REACT_APP_START_PAYING_DATE',
  );
  ...
  REACT_APP_COACH_FIRST_NAME = localStorage.getItem(
    'REACT_APP_COACH_FIRST_NAME',
  );
  ...
  if (url.includes('kristinwade')) {
    ...
    REACT_APP_ZOOM_LINK =
      'https://www.fiscal-bliss.com/booking-calendar/mybudgetcoach-meeting';
    ...
    REACT_APP_ZOOM_RATE = '65.00 USD / hour';
    REACT_APP_ZOOM_LINK =
      'https://calendly.com/personalwealthadventures/one-hour-session';
    ...
    REACT_APP_ZOOM_RATE = '39.99 USD / hour';
    REACT_APP_ZOOM_LINK =
      'https://meetings.hubspot.com/randi-degraw/mybudgetcoach';
    ...
    REACT_APP_ZOOM_LINK =
      'https://sites.google.com/view/ynab-coaching-with-celia/rates-and-appointments?authuser=0';
    ...
    REACT_APP_ZOOM_LINK =
      'https://JamaaWealthFinancialClientScheduling.as.me/?appointmentType=59397495';
    ...
    REACT_APP_ZOOM_LINK =
      'https://anitadombovari.as.me/?appointmentType=60426198';
  ...
  if (testPublishedAvatar != null) {
    ...
    if (testPublishedAvatar === 'anitadombovari') {
      ...
      REACT_APP_ZOOM_RATE = '75.00 USD / hour';
      REACT_APP_ZOOM_LINK =
        'https://stackdfinancialcoaching.as.me/MyBudgetCoach';
    } else if (testPublishedAvatar === 'trevorvance') {
      REACT_APP_COACH_FIRST_NAME = 'Trevor';
      REACT_APP_ZOOM_RATE = '60.00 USD / hour';
      REACT_APP_ZOOM_LINK =
        'https://tidycal.com/intentionalbudgets/mbc-consult';
      ...
      REACT_APP_ZOOM_RATE = '35.00 USD / hour';
      REACT_APP_ZOOM_LINK =
        'https://calendly.com/frugallymelody/my-budget-coach';
      ...
      REACT_APP_ZOOM_RATE = '55.00 USD / hour';
      REACT_APP_ZOOM_LINK =
        'https://tidycal.com/calmmoneywithkayla/mybudgetcoachsupport';
    } else if (testPublishedAvatar === 'jennyphan') {
      REACT_APP_COACH_FIRST_NAME = 'Jenny';
      REACT_APP_ZOOM_RATE = '50.00 USD / 30 Minute Session';
      REACT_APP_ZOOM_LINK =
        'https://stan.store/worththehappiness/p/mybudgetcoach-call';
    } else if (testPublishedAvatar === 'dariomartinezbatlle') {
      REACT_APP_COACH_FIRST_NAME = 'Darío';
      REACT_APP_ZOOM_RATE = '55.00 USD / hour';
      ...
      REACT_APP_ZOOM_RATE = '60.00 USD / hour';
      REACT_APP_ZOOM_LINK =
        'https://calendly.com/ynabwithchristine/budget_coaching';
    ...
    } else if (testPublishedAvatar === 'amydural') {
      REACT_APP_COACH_FIRST_NAME = 'Amy';
      REACT_APP_ZOOM_RATE = '50.00 USD / hour';
      REACT_APP_ZOOM_LINK = 'https://tidycal.com/amydural/30-minute-meeting';
    } else if (testPublishedAvatar === 'eileentong') {
      REACT_APP_COACH_FIRST_NAME = 'Eileen';
      REACT_APP_ZOOM_RATE = '55.00 USD / hour';
      REACT_APP_ZOOM_LINK =
        'https://calendly.com/et1234567/mybudgetcoach-session-1';
    } else if (testPublishedAvatar === 'skylerfleming') {
      REACT_APP_COACH_FIRST_NAME = 'Skyler';
      REACT_APP_ZOOM_RATE = '30.00 USD / hour';
      REACT_APP_ZOOM_LINK =
        'https://cal.com/moneytalkwithskylerfleming/60-minute-financial-coaching';
  ...
  if (REACT_APP_COACH === 'nataliegraham') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll get back to you as soon as I can.";
  } else if (REACT_APP_COACH === 'jonathanakerman') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll get back to you within 1 business day.";
  } else if (REACT_APP_COACH === 'trevorvance') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'I typically am able to respond within a business day.';
  } else if (REACT_APP_COACH === 'celiabenton') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'Feel free to message me anytime. I usually respond within two days.';
  } else if (REACT_APP_COACH === 'aitzanegron') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'I respond to messages during office hours on Tuesdays / Thursdays between 10:00am - 6:00pm EST.';
  } else if (REACT_APP_COACH === 'melodybarthelemy') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll reply during the evenings.";
  } else if (REACT_APP_COACH === 'alfredomatos') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll get back to you as soon as I can. (Puedes enviarme mensajes por aquí en cualquier momento. Responderé lo antes posible.)";
    ...
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll get back to you within 2-3 days.";
  } else if (REACT_APP_COACH === 'anitadombovari') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll usually get back to you within 1 business day.";
  } else if (REACT_APP_COACH === 'jennyphan') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll usually get back to you within 2 business days.";
  } else if (REACT_APP_COACH === 'dariomartinezbatlle') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll get back to you within 12 hours of receipt. (No dudes en enviarme un mensaje en cualquier momento. Me comunicaré con usted dentro de las 12 horas posteriores a la recepción.)";
  } else if (REACT_APP_COACH === 'niaadams') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'Feel free to message me anytime. I reply within two business days Mon - Friday. If possible please include screen shots with your questions.';
  } else if (REACT_APP_COACH === 'suerubincan') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'Please include a screenshot with your questions if possible and I will reply within two business days.';
  } else if (REACT_APP_COACH === 'amandaperez') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'I usually reply by the next business day. Please include screenshots with your questions when necessary. If you need more involved assistance, I may suggest a video call.';
    ...
    REACT_APP_RESPONSE_EXPECTATIONS =
      "Feel free to message me anytime. I'll reply as soon as I can.";
  } else if (REACT_APP_COACH === 'amydural') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'I will reply as soon as I can but within two business days.';
  } else if (REACT_APP_COACH === 'skylerfleming') {
    REACT_APP_RESPONSE_EXPECTATIONS =
      'I will reply within the next business day.';
  } else {
