...
export function UploadAvatarModal() {
  ...
  const onImport = async () => {
    ...
    const filepath = res2[0];
    console.log('stuffgo on xml?');
    console.log(filepath);

    const stuff = await send('uploaded-avatar-parse-file', {
      filepath,
    });
          ...
          <View style={{ lineHeight: 1.5 }}>
            {usingAlready == true && (
              <Block>
                ...
                <p>
                  You are currently testing <b>{REACT_APP_COACH_FIRST_NAME}</b>.
                  Ready to go back to your default experience?
                </p>
              </Block>
            )}
            {usingAlready == true && (
            ...
            {REACT_APP_COACH_FIRST_NAME != null && (
              <Block>
                ...
                <p>
                  Would you like to reset your coach's avatar? This will reset
                  them to the beginning of their conversations.
                </p>
                <Button
                  type="primary"
            ...
            {REACT_APP_COACH_FIRST_NAME != null && (
              <Block>
                ...
                <p>
                  Interested in switching to another coach? Reach out and we can
                  help you transition.
                </p>
                <Button
                  type="primary"
              ...
              REACT_APP_COACH_FIRST_NAME != null && (
                <>
                  <Block>
                    ...
                    <p>
                      Want to jump straight to a specific part of a
                      conversation? This is helpful for longer testing sessions.
                    </p>
                    <View
                      style={{
                        marginTop: -10,
            ...
            {REACT_APP_UI_MODE === 'coach' && (
              <Block style={{ marginBottom: '20px' }}>
                <h3 style={{ marginBottom: '-5px' }}>
                  Test a Published Coach's Avatar
                </h3>
                <p>
                  Want to test out another coach&apos;s avatar to get inspired?
                  Select a coach below:
                </p>
                <Select
            ...
            {REACT_APP_UI_MODE === 'coach' && (
              <>
                <Block>
                  ...
                  <p>
                    Want to test out your latest draw.io updates before
                    publishing them? Upload your file following these
                    instructions:
                  </p>
                  <ol>
                    ...
                    <li>
                      Use the Import button below to upload the saved file
                    </li>
                  </ol>
                </Block>
                <Block>
            ...
            {REACT_APP_UI_MODE === 'coach' &&
              REACT_APP_COACH_FIRST_NAME != null && (
                <>
                  <Block>
                    <h3 style={{ marginBottom: '-5px' }}>
                      Simulate a Conversation Starter
                    </h3>
                    <p>
                      Want to test a conversation starter without having to wait
                      for the right conditions to arise? Select one supported by
                      this avatar below:
                    </p>
                  </Block>
                  ...
                  {supportedTriggerTypes.includes('paycheck_received') && (
                    <Button
                      type="normal"
                      onClick={() => {
                        triggerFired('paycheck_received');
                      }}
                      style={{ marginTop: '0px' }}
                    >
                      Paycheck Received
                  ...
                  {supportedTriggerTypes.includes('not_seen_for_1_week') && (
                    <Button
                      type="normal"
                      onClick={() => triggerFired('not_seen_for_1_week')}
                      style={{ marginTop: '5px' }}
                    >
                  ...
                  {supportedTriggerTypes.includes('not_seen_for_2_weeks') && (
                    <Button
                      type="normal"
                      onClick={() => triggerFired('not_seen_for_2_weeks')}
                      style={{ marginTop: '5px' }}
                    >
                  ...
                  {supportedTriggerTypes.includes('middle_of_month') && (
                    <Button
                      type="normal"
                      onClick={() => triggerFired('middle_of_month')}
                      style={{ marginTop: '5px' }}
                    >
                      Middle of Month
                    </Button>
                  ...
                  {supportedTriggerTypes.includes('end_of_month') && (
                    <Button
                      type="normal"
                      onClick={() => triggerFired('end_of_month')}
                      style={{ marginTop: '5px' }}
                    >
                      End of Month
                    </Button>
                  ...
                  {supportedTriggerTypes.includes('one_week_since_sign_up') && (
                    <Button
                      type="normal"
                      onClick={() => triggerFired('one_week_since_sign_up')}
                      style={{ marginTop: '5px' }}
                    >
                  ...
                  {supportedTriggerTypes.includes(
                    'one_month_since_sign_up',
                  ) && (
                    <Button
                      type="normal"
                      onClick={() => triggerFired('one_month_since_sign_up')}
                      style={{ marginTop: '5px' }}
                    >
                  ...
                  {supportedTriggerTypes.includes(
                    'no_reconciliation_for_one_week',
                  ) && (
                    <Button
                      type="normal"
                      onClick={() =>
                        triggerFired('no_reconciliation_for_one_week')
                      }
                      style={{ marginTop: '5px' }}
                    >
                  ...
                  {supportedTriggerTypes.includes(
                    'no_reconciliation_for_one_month',
                  ) && (
                    <Button
                      type="normal"
                      onClick={() =>
                        triggerFired('no_reconciliation_for_one_month')
                      }
                      style={{ marginTop: '5px' }}
                    >
                  ...
                  {supportedTriggerTypes.includes(
                    'positive_credit_card_balance',
                  ) && (
                    <Button
                      type="normal"
                      onClick={() =>
                        triggerFired('positive_credit_card_balance')
                      }
                      style={{ marginTop: '5px' }}
                    >
                  ...
                  {supportedTriggerTypes.includes(
                    'more_than_ten_uncategorized_transactions',
                  ) && (
                    <Button
                      type="normal"
                      onClick={() =>
                        triggerFired('more_than_ten_uncategorized_transactions')
                      }
                      style={{ marginTop: '5px' }}
                    >
