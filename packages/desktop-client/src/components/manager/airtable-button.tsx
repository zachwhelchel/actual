  ...
  const handleClick = () => {
    ...
    const finalParams = {
      ...
      ...(paramsObject.utm_source && {
        prefill_utm_source: paramsObject.utm_source,
      }),
      ...(paramsObject.utm_medium && {
        prefill_utm_medium: paramsObject.utm_medium,
      }),
      ...(paramsObject.utm_campaign && {
        prefill_utm_campaign: paramsObject.utm_campaign,
      }),
      ...(paramsObject.utm_term && { prefill_utm_term: paramsObject.utm_term }),
      ...(paramsObject.utm_content && {
        prefill_utm_content: paramsObject.utm_content,
      }),
      ...(paramsObject._fprom_tid && {
        prefill__fprom_tid: paramsObject._fprom_tid,
      }),
      ...(paramsObject._fprom_ref && {
        prefill__fprom_ref: paramsObject._fprom_ref,
      }),
      hide_Advisor: true,
    };
